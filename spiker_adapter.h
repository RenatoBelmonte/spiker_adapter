...
#define SPIKER_ADAPTER_SPIKES_RESULT_SPIKES_RESULT_FIELD_WIDTH 32
#define SPIKER_ADAPTER_SPIKES_RESULT_SPIKES_RESULT_FIELDS_PER_REG 1
#define SPIKER_ADAPTER_SPIKES_RESULT_MULTIREG_COUNT 25

// Subword of results.
#define SPIKER_ADAPTER_SPIKES_RESULT_0_REG_OFFSET 0x64

// Subword of results.
#define SPIKER_ADAPTER_SPIKES_RESULT_1_REG_OFFSET 0x68

// Subword of results.
#define SPIKER_ADAPTER_SPIKES_RESULT_2_REG_OFFSET 0x6c

// Subword of results.
#define SPIKER_ADAPTER_SPIKES_RESULT_3_REG_OFFSET 0x70

// Subword of results.
#define SPIKER_ADAPTER_SPIKES_RESULT_4_REG_OFFSET 0x74

// Subword of results.
#define SPIKER_ADAPTER_SPIKES_RESULT_5_REG_OFFSET 0x78

// Subword of results.
#define SPIKER_ADAPTER_SPIKES_RESULT_6_REG_OFFSET 0x7c

// Subword of results.
#define SPIKER_ADAPTER_SPIKES_RESULT_7_REG_OFFSET 0x80

// Subword of results.
#define SPIKER_ADAPTER_SPIKES_RESULT_8_REG_OFFSET 0x84

// Subword of results.
#define SPIKER_ADAPTER_SPIKES_RESULT_9_REG_OFFSET 0x88

// Subword of results.
#define SPIKER_ADAPTER_SPIKES_RESULT_10_REG_OFFSET 0x8c

// Subword of results.
#define SPIKER_ADAPTER_SPIKES_RESULT_11_REG_OFFSET 0x90

// Subword of results.
#define SPIKER_ADAPTER_SPIKES_RESULT_12_REG_OFFSET 0x94

// Subword of results.
#define SPIKER_ADAPTER_SPIKES_RESULT_13_REG_OFFSET 0x98

// Subword of results.
#define SPIKER_ADAPTER_SPIKES_RESULT_14_REG_OFFSET 0x9c

// Subword of results.
#define SPIKER_ADAPTER_SPIKES_RESULT_15_REG_OFFSET 0xa0

// Subword of results.
#define SPIKER_ADAPTER_SPIKES_RESULT_16_REG_OFFSET 0xa4

// Subword of results.
#define SPIKER_ADAPTER_SPIKES_RESULT_17_REG_OFFSET 0xa8

// Subword of results.
#define SPIKER_ADAPTER_SPIKES_RESULT_18_REG_OFFSET 0xac

// Subword of results.
#define SPIKER_ADAPTER_SPIKES_RESULT_19_REG_OFFSET 0xb0

// Subword of results.
#define SPIKER_ADAPTER_SPIKES_RESULT_20_REG_OFFSET 0xb4

// Subword of results.
#define SPIKER_ADAPTER_SPIKES_RESULT_21_REG_OFFSET 0xb8

// Subword of results.
#define SPIKER_ADAPTER_SPIKES_RESULT_22_REG_OFFSET 0xbc

// Subword of results.
#define SPIKER_ADAPTER_SPIKES_RESULT_23_REG_OFFSET 0xc0

// Subword of results.
#define SPIKER_ADAPTER_SPIKES_RESULT_24_REG_OFFSET 0xc4

// Controls handshaking signal of the accelerator.
#define SPIKER_ADAPTER_CTRL1_REG_OFFSET 0xc8
#define SPIKER_ADAPTER_CTRL1_SAMPLE_READY_BIT 0
#define SPIKER_ADAPTER_CTRL1_READY_BIT 1

// Contains the current status of the accelerator.
#define SPIKER_ADAPTER_STATUS_REG_OFFSET 0xcc
#define SPIKER_ADAPTER_STATUS_SAMPLE_BIT 0
