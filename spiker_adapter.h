...
#define SPIKER_ADAPTER_SPIKES_RESULT_MULTIREG_COUNT 4
...
#define SPIKER_ADAPTER_CTRL1_REG_OFFSET 0x74
#define SPIKER_ADAPTER_CTRL1_SAMPLE_READY_BIT 0
#define SPIKER_ADAPTER_CTRL1_START_BIT 1

// Contains the current status of the accelerator.
#define SPIKER_ADAPTER_STATUS_REG_OFFSET 0x78
#define SPIKER_ADAPTER_STATUS_SAMPLE_BIT 0
#define SPIKER_ADAPTER_STATUS_READY_BIT 1
